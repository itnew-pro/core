<?php echo CHtml::form(); ?>
	...
	<div class="form-block">
		<?php echo CHtml::activeCheckbox($model, "isCover", array("class" => "checkbox", "checked" => $model->hasCover())); ?>
		...
		<div class="form-block-container form-block-container-cover">
			<div class="form-block">
				<div class="form-internal">
					...
					<?php echo CHtml::activeTextField($model->getCover(), "width", array("class" => "blue-form form-small", "name" => "Cover[width]")); ?>
					px
				</div>
				<div class="form-internal">
					<?php echo CHtml::activeLabel($model->getCover(), "height"); ?>
					<?php echo CHtml::activeTextField($model->getCover(), "height", array("class" => "blue-form form-small", "name" => "Cover[height]")); ?>
					px
				</div>
			</div>
		</div>
	...
	<div class="form-block">
		<?php echo CHtml::activeCheckbox($model, "isImages", array("class" => "checkbox", "checked" => $model->hasImages())); ?>
		...
		<div class="form-block-container form-block-container-images">
			<div class="form-block">
				<div class="form-internal">
					...
					<?php echo CHtml::activeTextField($model->getImages(), "width", array("class" => "blue-form form-small")); ?>
					px
				</div>
				<div class="form-internal">
					<?php echo CHtml::activeLabel($model->getImages(), "height"); ?>
					<?php echo CHtml::activeTextField($model->getImages(), "height", array("class" => "blue-form form-small")); ?>
					px
				</div>
			</div>
			...
			<div class="form-block">
				...
				<?php echo CHtml::activeDropDownList($model->getImages(), "view", $model->getImages()->getViewList(), array("id" => "images-view")); ?>
			</div>
			...
			<div class="form-block">
				<div class="hide form-style-images-view form-thumb-images-view">
					<div class="form-internal">
						...
						<?php echo CHtml::activeTextField($model->getImages(), "thumb_width", array("class" => "blue-form form-small")); ?>
						px
					</div>
					<div class="form-internal">
						<?php echo CHtml::activeLabel($model->getImages(), "thumb_height"); ?>
						<?php echo CHtml::activeTextField($model->getImages(), "thumb_height", array("class" => "blue-form form-small")); ?>
						px
					</div>
				</div>
			</div>
...
<?php
	Yii::app()->clientScript->registerScript("imageSettings", '
		...
		{
			if ($("#images-view").val() == ' . Images::TYPE_LITEBOX . ') {
		...
		showFormBlockContainerCover();
		$("#Records_isCover").change(function() {
			showFormBlockContainerCover();
		});
		function showFormBlockContainerCover()
		{
			if ($("#Records_isCover").prop("checked")) {
		...
		showFormBlockContainerImages();
		$("#Records_isImages").change(function() {
			showFormBlockContainerImages();
		});
		function showFormBlockContainerImages()
		{
